...
<div id="basket_items_list">
	<div class="bx_ordercart_order_table_container">
        <table class="table table-bordered" id="basket_items">
			<thead>
				<tr>
					<td class="margin"></td>
					<?
				...
				?>
					<tr id="<?=$arItem["ID"]?>">
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							if (in_array($arHeader["id"], array("PROPS", "DELAY", "DELETE", "TYPE", "QUANTITY"))) // some values are not shown in the columns in this template
								continue;
	...
	<div class="bx_ordercart_order_pay">
		...
		?>
			<div class="bx_ordercart_coupon">
                <span><?=GetMessage("STB_COUPON_PROMT")?></span><input class="input" type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();">
			</div><?
