...
$MESS['M_SERVICE_EMPLOYES'] = 'Врачи по услуге';
$MESS['M_SERVICE_CLINICS'] = 'Клиники по услуге';

$MESS['M_TAB_DESCRIPTION'] = 'Описание';
$MESS['M_TAB_ANALYSIS'] = 'Анализы';
$MESS['M_TAB_DOCUMENTS'] = 'Документы';
$MESS['M_TAB_INDICATIONS'] = 'Показания';
$MESS['M_TAB_CONTRAINDICATIONS'] = 'Противопоказания';
$MESS['M_TITLE_AMBULATORY'] = 'Амбулаторно-поликлиническая помощь';

$MESS['M_BTN_ALL_DOCROTRS'] = 'Все врачи';
?>