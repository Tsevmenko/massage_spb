...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div class="bx_catalog_item_controls_blockone"><div style="display: inline-block;position: relative;">
			<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="btn bx_small" rel="nofollow">-</a>
			...
			<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="btn bx_small" rel="nofollow">+</a>
...
<?
	...
	else
	{
		...
		else
		{
			?>
		<div class="bx_catalog_item_controls no_touch">
			<a class="btn bx_medium" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><?
