...
<div class="bx_ordercart">
			...
			<thead>
				<tr>
					...
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arColumn):
						...
						if (in_array($arColumn["id"], array("PROPS", "TYPE", "NOTES", "QUANTITY"))) // some values are not shown in columns in this template
							continue;
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="bx_section">
            ...
            <div class="bx_block w100"><textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" class="input input-block"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea></div>
