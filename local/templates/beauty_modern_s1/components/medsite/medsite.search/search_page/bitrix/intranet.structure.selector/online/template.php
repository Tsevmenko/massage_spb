...
?>
<input type="checkbox" name="<? echo $arParams['FILTER_NAME'].'_IS_ONLINE' ?>"
       value="Y" <? echo $bChecked ? 'checked="checked"' : '' ?> id="<? echo $arParams['FILTER_NAME'].'_IS_ONLINE' ?>"
       title="<? echo GetMessage('ISS_TPL_ONLINE_TITLE') ?>" onclick="<? echo $onclick ?>"/>
<label for="<? echo $arParams['FILTER_NAME'].'_IS_ONLINE' ?>"
       title="<? echo GetMessage('ISS_TPL_ONLINE_TITLE') ?>"><? echo GetMessage('ISS_TPL_ONLINE_LABEL') ?></label>
