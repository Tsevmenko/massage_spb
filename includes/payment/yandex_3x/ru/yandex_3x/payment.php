...
<br />
<input class="btn btn-blue" name="BuyButton" value="Оплатить" type="submit">
<br />
<br />

</font><p><font class="tablebodytext"><b>Обратите внимание:</b> если вы откажетесь от услуги, для возврата денег вам придется обратиться в медицинское учреждение, куда вы записывались.</font></p>
</form>